...
namespace SK.Tekla.Drawing.Automation.Drawing.Views
{
    public class SKSectionViewOld
    {
        ...
        public SKSectionViewOld(SKCatalogHandler catalogHandler,
            ...
            StreamlineDrawing streamlineDrawing, SKAngleHandler skAngleHandler, SKBoltHandler skBoltHandler)
        {
            ...
            this.streamlineDrawing = streamlineDrawing;
            this.skAngleHandler = skAngleHandler;
            this.skBoltHandler = skBoltHandler;
        }

        public void SectionView(Model mymodel, DrawingHandler my_handler,
                ...
                if (current_view != null)
                {
                    ...
                    foreach (var list_of_parts in list[z].RequiredPartList)
                    {
                        ...
                        if (prof_typ == "L")
                        {
                            ...
                            skAngleHandler.angle_place_check_for_hole_locking(angle_hole_locking_check, out rd_point_list, 
                                enum_for_bolt, current_view, ref SECTION_VIEW_PARTMARK_TO_RETAIN, ref SECTION_VIEW_BOLTMARK_TO_RETAIN_POS, ref SECTION_VIEW_BOLTMARK_TO_RETAIN_NEG);
